...
namespace Payroll.UI.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        private IUserServiceDomain _userRepository;

        public ManageController(IUserServiceDomain userRepository)
        {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var user = _userRepository.GetUserById(HttpContext.User.Identity.GetUserId());
            ViewBag.User = user;
            return View(model);
        }
